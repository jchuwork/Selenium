...
public class CPStagingLoggingInWithGitHub {
	...
	public void test() {
			...
			System.out.println("Github - Logging In Successfully on FF"); 
			...
			System.out.println("Github - Logged Out Successfully on FF"); 
