package signupNewUserCPStaging;
...
public class SignUpNewHacker {
	...
	public void test() {
			...
			System.out.println("Signed up new email user.  Please do not forget to confirm the email address.");
