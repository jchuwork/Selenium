...
public class CreateSoftwareProject {
	...
	public static void test(FirefoxDriver string) {
			...
			driver.findElement(By.id("software-thumbnail-button")).sendKeys("/Users/jchubacca/Documents/workspace/Webdriver/seleniumimage.jpg");
			...
			*/
    		...
    		driver.findElement(By.id("software_photo_data")).sendKeys("/Users/jchubacca/Documents/workspace/Webdriver/seleniumimage.jpg");
