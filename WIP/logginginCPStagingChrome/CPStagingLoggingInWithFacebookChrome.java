...
public class CPStagingLoggingInWithFacebookChrome {
	...
	public void test() {
			...
			driver.findElement(By.xpath(".//*[@id='signin-users']/div/div[1]/div[1]/a[3]")).click();
			waitforelements(2000);
						
			driver.findElement(By.id("email")).sendKeys("myrecipes004@gmail.com");
			driver.findElement(By.id("pass")).sendKeys("recipes004");
			driver.findElement(By.id("loginbutton")).click();
			System.out.println("Facebook - Logging In Successfully"); 
